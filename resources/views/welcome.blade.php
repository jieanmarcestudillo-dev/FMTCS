        ...
        <div class="container-fluid py-5 mt-3" id="categorySection">
            <div class="container">
                <div class="position-relative d-flex align-items-center justify-content-center">
                    <h1 class="display-1 text-uppercase text-white" style="-webkit-text-stroke: 1px #dee2e6;">Category</h1>
            ...
            <div class="container mt-3">
                <div class="row justify-content-around text-center">
                    <div class="col-lg-3 col-sm-12">
                        <a href="/viewGearCategory">
                            <div class="card">
                                <img alt="image" src="./image/frontend/gear.png"  class="card-img-top">
                                <div class="card-body">
                                  <a href="/viewGearCategory" class="btn btn-link nav-link">GEARS</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 my-lg-0 col-sm-12 my-4">
                        <a href="/viewBoltsCategory">
                            <div class="card">
                                <img alt="image" src="./image/frontend/bolts.jpg"  class="card-img-top">
                                <div class="card-body">
                                <a href="/viewBoltsCategory" class="btn btn-link nav-link">BOLTS</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-12">
                        <a href="/viewOtherCategory">
                            <div class="card">
                                <img alt="image" src="./image/frontend/machine.jpg"  class="card-img-top">
                                <div class="card-body">
                                <a href="/viewOtherCategory" class="btn btn-link nav-link">OTHERS</a>
                                </div>
                            </div>
                        </a>
                    </div>
