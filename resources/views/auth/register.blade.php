            ...
            <section class="main login">
                <div class="container text-center">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <x-text-input id="password_confirmation" class="block mt-1 w-full form-control rounded-0" type="password" id="password_confirmation" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password"/>
                        ...
                        <div class="mb-3 checkBox text-start">
                            <input type="checkbox" class="form-check-input ms-1" onclick="signUpPassword()">
