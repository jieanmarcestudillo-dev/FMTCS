...
<body>
    ...
    <div class="section mt-4">
        <p class="fw-bold font-size font text-center mt-4">COMPLETED ORDERS SUMMARY</p>
        <table class="table table-sm table-border text-center align-middle mt-3">
            ...
            <tbody>
                ...
                <tr class="font-size font">
                    <td>{{ $count + 1 }}</td>
                    <td>{{ $certainData->track_num }}</td>
                    <td>{{ $certainData->name }}</td>
                    <td>{{ $certainData->phone }}</td>
                    <td>{{ date('F d, Y', strtotime($certainData->created_at)) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
